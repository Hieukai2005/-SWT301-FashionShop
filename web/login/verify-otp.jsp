                    ...
                    <div class="authfy-login">
                        <div class="authfy-panel panel-login text-center active">
                            ...
                            <div class="authfy-heading">
                                <h3 class="auth-title">Xác minh OTP</h3>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12">
                                    ...
                                    <form class="loginForm" action="verifyotp" method="POST">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="otp" placeholder="Mã OTP 6 số" required>
                                        </div>
